...
import DeclarationValidee from './DeclarationValidee';


import './blogdeclaration.css';

export const ListeMesDeclarations = ({MyData}) => {
  return (
    <MDBContainer style={{backgrounColor: 'white'}}>
            ...
            <MDBRow className='declaration' key={blog.id}>
                ...
                <MDBCol md='1'>
                    <button onClick={<DeclarationValidee></DeclarationValidee>}>Consulter</button>
                </MDBCol>
            </MDBRow>
            ) )}
...
export default ListeMesDeclarations;
