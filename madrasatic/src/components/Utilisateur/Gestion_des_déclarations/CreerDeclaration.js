...
import { AjoutDeclaration } from '../../Déclarations/AjoutDeclarations';
import {
    MDBNavbar,
    MDBNavbarBrand,
    MDBBtn,
...
export const CreerDeclaration = () => {
  ...
  return (
    <header>
        ...
        <AjoutDeclaration></AjoutDeclaration>
    </header>
  )
}

export default CreerDeclaration;
